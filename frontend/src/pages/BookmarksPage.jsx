const BookmarksPage = ({ bookmarks = [] }) => {
  return (
    <div className="container py-4">
      <p className="eyebrow mb-1">Bookmarks</p>
      <h1 className="h2 fw-bold mb-2">Saved questions</h1>
      <p className="text-secondary mb-4">Revisit the software interview questions you marked for revision.</p>
      {bookmarks.length ? (
        <div className="vstack gap-3">
          {bookmarks.map((question) => (
            <div className="glass-card p-4" key={question._id}>
